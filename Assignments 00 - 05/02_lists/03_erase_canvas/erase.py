# This program creates a grid of blue squares on a canvas. The user can then click to create a pink eraser that can be moved around the canvas to erase the blue squares it touches.
