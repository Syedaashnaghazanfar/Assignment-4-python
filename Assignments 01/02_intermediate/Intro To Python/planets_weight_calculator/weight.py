# Define gravitational constants for different planets
...
def main():
    ...
    if planet == "Mercury":
        ...
        # Assuming the user enters one of the planets listed
        gravity_constant = NEPTUNE_GRAVITY
    
    # Calculate the equivalent weight on the selected planet
    planetary_weight = earth_weight * gravity_constant
    
    # Round the planetary weight to 2 decimal places for clarity
